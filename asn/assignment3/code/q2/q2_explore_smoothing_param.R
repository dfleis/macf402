...
# plot data
pdf("./plots/q2/expl_fitted_smile_mar.pdf", height = 6, width = 6)
...
# plot data
pdf("./plots/q2/expl_fitted_smile_apr.pdf", height = 6, width = 6)
par(mfrow = c(2,2), oma = c(0, 0, 2, 0)) 
plot(sigma~obs_moneyness,
     xlab = "Moneyness = S/K", ylab = "Implied Volatility",
     main = paste0("h = ", h[1]))
...
# plot data
pdf("./plots/q2/expl_fitted_smile_may.pdf", height = 6, width = 6)
par(mfrow = c(2,2), oma = c(0, 0, 2, 0)) 
plot(sigma~obs_moneyness,
     xlab = "Moneyness = S/K", ylab = "Implied Volatility",
     main = paste0("h = ", h[1]))
